/**
 * Initially sourced from https://github.com/github-linguist/linguist/blob/master/lib/linguist/languages.yml
 */
...
export const languages: { [k in string]: Language } = {
  '1C Enterprise': {
    type: 'programming',
    color: '#814CCC',
    extensions: ['.bsl', '.os'],
...
export const programmingLanguageExtensions = Object.values(languages).reduce(
  (extensions: string[], language) => {
    if (language.type === 'programming' && language.extensions) {
      extensions.push(...language.extensions);
    }
